...
export class Surfaces_Demo extends Scene {
	constructor(scene_id, material) {
		...
		} else this['construct_scene_' + scene_id]();
	}
	...
	construct_scene_2() {
		this.shapes = {
			...
			donut2: new (defs.Torus.prototype.make_flat_shaded_version())(
				20,
				20,
				[
					[0, 2],
	...
	display_scene_3(context, program_state) {
		const model_transform = Mat4.rotation(
	...
	show_explanation(document_element, webgl_manager) {
		if (this.is_master) {
			...
			for (let i = 0; i < this.num_scenes; i++) {
				...
				const code = new tiny.Code_Widget(
					element_2,
				...
				const code_2 = new tiny.Code_Widget(
					element_3,
